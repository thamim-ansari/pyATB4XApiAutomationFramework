...
class TestCRUDBooking(object):
    ...
    def test_update_booking_id_token(self, create_token, get_booking_id):
        put_url = APIConstants.patch_put_delete_booking_url(booking_id=get_booking_id)
        print(put_url)
    ...
    def test_delete_booking_id(self, create_token, get_booking_id):
        delete_url = APIConstants.patch_put_delete_booking_url(booking_id=get_booking_id)
